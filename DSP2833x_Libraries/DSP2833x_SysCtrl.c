...
void InitSysCtrl(void)
{
   ...
   InitPll(DSP28_PLLCR,DSP28_DIVSEL);   //DSP28_PLLCR frequency multiplication 10, DSP28_DIVSEL divide frequency 2
   //30 * 10 / 2 = 150MHz
   // Initialize the peripheral clocks
   InitPeripheralClocks();  //had enable all device clock
}
